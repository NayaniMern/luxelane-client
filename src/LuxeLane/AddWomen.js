...
const AddWomen = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    axios
      .post(`https://luxelane-server-zyhb.onrender.com/womens`, {
        discount,
        image1,
        image2,
        image3,
      ...
      .then((res) => {
        alert("You Have Successfully Posted Women's Product Data");
  ...
  return (
    <div className="container p-5 addwomen">
      <h3 className="text-center text-uppercase mb-4">Add Women's wear details</h3>
