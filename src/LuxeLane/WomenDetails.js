...
const WomenDetails = () => {
  ...
  useEffect(() => {
    axios.get(`https://luxelane-server-zyhb.onrender.com/womens/${id}`).then((res) => setWomen(res.data));
  });
  ...
  const productImages = [women.image1, women.image2, women.image3, women.image4];
          ...
          <div className="row text-center">
            <div className="col-lg-12">
              ...
              <div className="d-flex justify-content-center">
                <h5 className="me-5"><NavLink style={{textDecoration:"none",  color: "inherit"}} to ="/women">Women</NavLink> </h5>
                <h6 className="">Women's Product Details</h6>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row overflow-hidden">
            <div className="mb-4">
              <span>
                ...
                <i className="bi bi-chevron-right"></i> Women
                <i className="bi bi-chevron-right"></i> {women.category}
              </span>
            </div>
            ...
            <div className="col-md-12 col-xl-6 px-3 product-details-right">
              ...
              <h3>
                Brand:<span>{women.brand}</span>{" "}
              </h3>
              <h5>
                colour:<span>{women.colour}</span>
              </h5>
              <h2 className="d-flex mt-3 gap-2 flex-wrap">
                <button
                  className="btn border text-center"
                  style={{ backgroundColor: "#f8d7da", color: "#000", width: "50px", height: "50px" }}
                  type="button"
                ...
                <button
                  className="btn border text-center"
                  style={{ backgroundColor: "#d1ecf1", color: "#000", width: "50px", height: "50px" }}
                  type="button"
                ...
                <button
                  className="btn border text-center"
                  style={{ backgroundColor: "#d4edda", color: "#000", width: "50px", height: "50px" }}
                  type="button"
                ...
                <button
                  className="btn border text-center"
                  style={{ backgroundColor: "#fff3cd", color: "#000", width: "50px", height: "50px" }}
                  type="button"
                ...
                <button
                  className="btn border text-center"
                  style={{ backgroundColor: "#cce5ff", color: "#000", width: "50px", height: "50px" }}
                  type="button"
                ...
                <button
                  className="btn border text-center"
                  style={{ backgroundColor: "#e2e3e5", color: "#000", width: "50px", height: "50px" }}
                  type="button"
              ...
              <div className="price">
                <div className="d-flex">
                  <span className="discount">{women.discount} off</span>
                  <span className="dp">{women.dp}</span>
                </div>
                <h5 className="op ">
                  MRP:<span className="mx-2">{women.op}</span>
                </h5>
              </div>
                  ...
                  >
                    <div className="row  product">
                      <div className="col-lg-6">
                        <ul className="">
                          <li>
                            Fit: <span>{women.features?.fit}</span>
                          </li>
                          <li>
                            Material: <span>{women.features?.material}</span>
                          </li>
                          <li>
                            Sleeve: <span>{women.features?.sleeve}</span>
                          </li>
                          <li>
                            Collar: <span>{women.features?.collar}</span>
                          </li>
                          <li>
                            Pattern: <span>{women.features?.pattern}</span>
                          </li>
                          <li>
                            Occasion: <span>{women.features?.occasion}</span>
                          </li>
                        </ul>
                      </div>
                      <div className="col-lg-6">
                        <ul>
                          <li>
                            Length: <span>{women.features?.length}</span>
                          </li>
                          <li>
                            Closure: <span>{women.features?.closure}</span>
                          </li>
                          <li>
                            Transparency :{" "}
                            <span>{women.features?.transparency}</span>
                          </li>
                          <li>
                            Stretch: <span>{women.features?.stretch}</span>
                          </li>
                          <li>
                            Hemline: <span>{women.features?.hemline}</span>
                          </li>
                          <li>
                            Placket: <span>{women.features?.placket}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
