...
const AddMen = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    axios
      .post(`https://luxelane-server-zyhb.onrender.com/mens`, {
        discount,
        image1,
        image2,
        image3,
      ...
      .then((res) => {
        alert("You Have Successfully Posted Men's Product Data");
  ...
  return (
    <div className="container p-5 addmen">
      <h3 className="text-center text-uppercase mb-4">
        Add Men's wear details
      </h3>
