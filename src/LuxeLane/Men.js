...
const Men = () => {
  ...
  const getUnique = (key) => {
    const values = men.map((item) => item[key]); // get all values for key
...
// Checkbox change handler
  ...
  return (
    <section className="men-container">
      ...
      <section className="container p-4 mens-container">
        <h1 className="mb-5">Men's Fashion</h1>
            ...
            <div className="row">
              {filteredMen.length > 0 ? (
                  ...
                  >
                    <div className="card bg-transparent w-100 h-100 shadow main">
                      ...
                      <div className="card-body">
                        <h2 className="mb-3">{men.name}</h2>
                        <h5>{men.brand}</h5>
                        <div className="d-flex justify-content-between">
                          <div>
                            <span className="ms-2">{men.dp}</span>
                            <span className="ms-3 op">{men.op}</span>
                          </div>
                          <NavLink to={`/menDetails/${men._id}`}>
                            <img src={v} alt="error" />
                          </NavLink>
                        </div>
                      </div>
                ...
                <div className="text-center mt-5">
                  <img src={no} className="w-50 h-75" alt="errror"/>
